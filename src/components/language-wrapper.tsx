...
const translations = {
  ...
  en: {
    ...
    plans: {
      ...
      desc: "Create a custom travel plan recommended by AI.",
      destinationLabel: "Destination",
      destinationPlaceholder: "Enter the city or country you want to travel to",
      periodLabel: "Travel Duration",
      createButton: "Create Plan",
      aiRecommendCustomPlan: "Create a custom travel plan recommended by AI.",
      destination: "Destination",
      enterCityOrCountry: "Enter the city or country you want to travel to",
  ...
  zh: {
    ...
    plans: {
      ...
      destinationPlaceholder: "请输入您想去的城市或国家",
      periodLabel: "旅行时长",
      createButton: "创建计划",
      aiRecommendCustomPlan: "AI为您推荐定制旅行计划。",
      destination: "目的地",
      enterCityOrCountry: "请输入您想去的城市或国家",
      tripDuration: "旅行时长",
    },
  },
  ja: {
    ...
    plans: {
      title: "旅行計画を作成",
      desc: "AIがあなたに合わせた旅行計画を提案します。",
      destinationLabel: "目的地",
      destinationPlaceholder: "行きたい都市や国を入力してください",
      periodLabel: "旅行期間",
      createButton: "計画を作成",
      aiRecommendCustomPlan: "AIがあなたに合わせた旅行計画を提案します。",
      destination: "目的地",
      enterCityOrCountry: "行きたい都市や国を入力してください",
      tripDuration: "旅行期間",
    },
  },
  vi: {
    ...
    plans: {
      ...
      desc: "AI đề xuất kế hoạch du lịch tùy chỉnh cho bạn.",
      destinationLabel: "Điểm đến",
      destinationPlaceholder: "Nhập thành phố hoặc quốc gia bạn muốn đến",
      periodLabel: "Thời gian du lịch",
      createButton: "Tạo kế hoạch",
      aiRecommendCustomPlan: "AI đề xuất kế hoạch du lịch tùy chỉnh cho bạn.",
      destination: "Điểm đến",
      enterCityOrCountry: "Nhập thành phố hoặc quốc gia bạn muốn đến",
      tripDuration: "Thời gian du lịch",
    },
  },
  id: {
    logo: "Plan Go",
    ...
    plans: {
      ...
      desc: "AI merekomendasikan rencana perjalanan khusus untuk Anda.",
      destinationLabel: "Tujuan",
      destinationPlaceholder: "Masukkan kota atau negara yang ingin Anda kunjungi",
      periodLabel: "Durasi Perjalanan",
      createButton: "Buat Rencana",
      aiRecommendCustomPlan: "AI merekomendasikan rencana perjalanan khusus untuk Anda.",
      destination: "Tujuan",
      enterCityOrCountry: "Masukkan kota atau negara yang ingin Anda kunjungi",
